...
#    Updated: 2023/08/08 23:19:18 by novsiann         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = src/main.c src/lexer_1.c src/lexer_2.c src/read_input.c src/lexer_utils.c src/token.c src/pars.c src/pars_utils.c
OBJS = ${SRCS:.c=.o}
