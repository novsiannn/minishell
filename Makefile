...
SRCS = src/env.c src/main.c src/handler.c src/signals.c src/free.c src/lexer_1.c src/lexer_2.c src/lexer_3.c src/array_reading.c src/clear.c src/read_input.c src/pipe_group.c src/lexer_utils.c src/token.c src/pars.c src/pars_utils.c
OBJS = ${SRCS:.c=.o}
